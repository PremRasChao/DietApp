  ...
  return (
    <View className="bg-bone px-6 py-16">
      <View className="max-w-screen-lg mx-auto w-full">
        <Text
          className="text-espresso font-bold text-3xl mb-2 text-center"
          style={{ fontFamily: "Fraunces_700Bold" }}
        >
          Our Services
        </Text>
        <Text className="text-taupe text-base text-center mb-10">
          ...
          {mockServices.map((service) => (
            ...
            >
              <Card className="h-full">
                ...
                <Text
                  className="text-espresso font-bold text-lg mb-2"
                  style={{ fontFamily: "Fraunces_700Bold" }}
                >
                  {service.title}
                </Text>
                <Text className="text-taupe text-sm leading-relaxed">
                  {service.description}
                </Text>
              </Card>
            </View>
